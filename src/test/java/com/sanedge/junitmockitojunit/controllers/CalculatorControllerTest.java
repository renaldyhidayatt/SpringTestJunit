...
import com.sanedge.junitmockitojunit.controller.CalculatorController;
...
public class CalculatorControllerTest {
    ...
    void testAddFunction_Success(){
        System.out.println("Test Addtion Success Scenario");
    ...
    void testMultiply(){
        ...
        Assertions.assertEquals(HttpStatus.OK.value(), responseEntity.getStatusCodeValue(), "Expecting the status as OK");
    }
}
